...
def main(args):
    ...
    logger = TensorBoardLogger(
        save_dir=os.path.join(args.results_dir, args.proj_dir, "TB_logs"),
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="log_pc_err",
        type=str,
        choices=["pc_err", "log_mse", "log_pc_err", "log_abs_err"],
    )

    parser.add_argument("--which_spacing", default="linspaced", type=str)
    parser.add_argument(
        "--proj_dir",
        default="rate_integrating",
        type=str,
    ...
    parser.add_argument("--val_samp", default=0.2, type=float)
